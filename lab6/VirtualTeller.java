...
/*  VirtualTeller.java 
 * According to the requirement, BadAccountExceptions and BadTransExceptions was not 
 * caught here in VirtualTeller.java, those exceptions were caught in main method();
 * */
 ...
 * @throws BadAccountException 
   */
  public void withdraw(int acct, int amount) throws BadAccountException, BadTransException  {
...
//                         acct + "'" );
   ...
   *  @param amount an amount of money.
   */
  public void deposit(int acct, int amount) throws BadAccountException, BadTransException{
    AccountData account = findAccount(acct);
