...
public class BankApp {
  ...
  *  @exception IOException if there are problems reading user input.
  */
  private void doDeposit() throws IOException, BadAccountException, BadTransException {
    // Get account number.
   ...
   *  @exception IOException if there are problems reading user input.
   */
  private void doWithdraw() throws IOException, BadAccountException, BadTransException {
    // Get account number.
    int acctNumber = readInt("Enter account number: ");
