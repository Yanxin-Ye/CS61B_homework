...
//nicole test
    l.insertFront(23);
    System.out.println("\nInserting 23 at front.\nList with 23, 8 and 9 is " + l);
    if (l.head == null) {
      System.out.println("head is null.");
    } else {
      if (l.head.item != 23) {
...
//      if (l.head.next != l.tail) {
//        System.out.println("head.next is wrong."+ l.head.next.item);
//      }
    }
    if (l.tail == null) {
      System.out.println("tail is null.");
...
//remove    
    ...
    if (l.size != 1) {
      System.out.println("size is wrong. wrong size is :"+l.size);
    }  
    ...
    //ny test
    DList1 m = new DList1();
    m = new DList1(100, 200);
    System.out.println("now m is "+m+", the size of m is "+m.size+","
    		+ " and the head of m is "+m.head.item+", and the tail of m is "+m.tail.item);
    m.insertFront(50);
    System.out.println("now m is "+m+", the size of m is "+m.size+","
    		+ " and the head of m is "+m.head.item+", and the tail of m is "+m.tail.item);
    m.insertFront(10);
